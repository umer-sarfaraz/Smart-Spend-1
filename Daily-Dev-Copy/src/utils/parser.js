...
export const CATEGORIES = {
  vegetables: { label: 'Vegetables', icon: '\u{1F966}', color: '#97C459', gradient: 'linear-gradient(135deg, #688F33, #97C459)' },
  ...
  meat: { label: 'Meat & Seafood', icon: '\u{1F969}', color: '#E8896B', gradient: 'linear-gradient(135deg, #A83C1A, #E8896B)' },
  ...
  fuel: { label: 'Fuel & Transport', icon: '⛽', color: '#5BA3E8', gradient: 'linear-gradient(135deg, #1862AA, #5BA3E8)' },
  dining: { label: 'Cafe & Dining', icon: '☕', color: '#EF9F27', gradient: 'linear-gradient(135deg, #B4720D, #EF9F27)' },
  ...
  other: { label: 'General / Other', icon: '\u{1F4E6}', color: '#9AA3AF', gradient: 'linear-gradient(135deg, #565F6C, #9AA3AF)' }
};
