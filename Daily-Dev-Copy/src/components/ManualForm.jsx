  ...
  const handleSubmit = (e) => {
    ...
    try {
      confetti({
        ...
        spread: 60,
        origin: { y: 0.8 },
        colors: ['#A99BFA', '#34D399', '#f59e0b', '#f43f5e']
      });
    } catch (err) {
    ...
    <div className="drawer-overlay" onClick={onClose}>
      <div className="drawer-sheet" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="drawer-header">
          ...
          <button onClick={onClose} style={{ background: 'none', border: 'none', color: '#5A6270', cursor: 'pointer' }}>
            <X size={20} />
          </button>
        </div>
          ...
          <div style={{ display: 'flex', gap: '8px', background: 'rgba(255,255,255,0.03)', padding: '4px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.06)' }}>
            <button
              ...
              style={{
                ...
                color: entryMode === 'simple' ? '#fff' : '#5A6270',
                fontWeight: 700,
                fontSize: '0.8rem',
                cursor: 'pointer'
              }}
            ...
            <button
              ...
              style={{
                ...
                color: entryMode === 'itemized' ? '#fff' : '#5A6270',
                fontWeight: 700,
                fontSize: '0.8rem',
                cursor: 'pointer'
              }}
              ...
              {items.map((item, idx) => (
                <div key={idx} style={{ display: 'flex', flexDirection: 'column', gap: '10px', padding: '14px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '18px' }}>
                  ...
                  {focusedRowIndex === idx && getRowSuggestions(item.name).length > 0 && (
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', padding: '6px 10px', background: 'rgba(169, 155, 250, 0.04)', border: '1px solid rgba(169, 155, 250, 0.15)', borderRadius: '10px', animation: 'fadeIn 0.2s ease-in' }}>
