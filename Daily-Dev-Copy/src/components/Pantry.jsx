  ...
  const handleRolloverBudget = () => {
    ...
    try {
      confetti({
        ...
        spread: 90,
        origin: { y: 0.6 },
        colors: ['#a3e635', '#34D399', '#60a5fa', '#A99BFA']
      });
    } catch (err) {
      console.warn(err);
    }
    ...
    <div className="pantry-view" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div className="glass-card" style={{ display: 'flex', gap: '12px', padding: '16px' }}>
            <button 
              ...
              className="solid-btn" 
              style={{ flex: 1, padding: '12px', background: 'linear-gradient(135deg, #a3e635, #34D399)', borderRadius: '14px' }}
            >
              🧊 Scan Refrigerator
            </button>
            <button 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {DEMO_PANTRY_ITEMS.fridge.map((item, idx) => (
                <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 10px', background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)', borderRadius: '10px', fontSize: '0.78rem' }}>
                  ...
                  <span style={{ color: '#5A6270', fontWeight: 600 }}>Not audited yet</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {scannedItems.length > 0 && !isProcessing && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div className="cat-bar-bg" style={{ height: '6px' }}>
                      <div 
                        ...
                        style={{ 
                          ...
                          background: item.fullPercent > 30 ? 'linear-gradient(90deg, #a3e635, #34D399)' : 'linear-gradient(90deg, #f43f5e, #fb7185)'
                        }}
                      />
                    </div>
                  </div>
          ...
          <div className="glass-card" style={{ background: 'linear-gradient(135deg, rgba(163, 230, 53, 0.08) 0%, rgba(52, 211, 153, 0.03) 100%)', borderColor: 'rgba(163, 230, 53, 0.25)', padding: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '16px', fontSize: '0.78rem', color: '#8A93A0', lineHeight: '1.4' }}>
            ...
            {hasRolledOver ? (
              <div style={{ display: 'flex', gap: '8px', alignItems: 'center', justifyContent: 'center', color: '#34D399', background: 'rgba(52, 211, 153, 0.05)', padding: '12px', borderRadius: '12px', border: '1px solid rgba(52, 211, 153, 0.15)', fontSize: '0.82rem', fontWeight: 700 }}>
        ...
        <div className="drawer-overlay" onClick={() => setShowScanner(false)}>
          <div className="drawer-sheet" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="drawer-header">
              ...
              <button onClick={() => setShowScanner(false)} style={{ background: 'none', border: 'none', color: '#5A6270', cursor: 'pointer' }}>
                <X size={20} />
              </button>
            </div>
            ...
            {!isProcessing && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                ...
                {!cameraError ? (
                  ...
                  <div className="scanner-viewport" style={{ height: '180px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '12px', padding: '16px', gap: '10px' }}>
                    ...
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <p style={{ fontSize: '0.7rem', color: '#8A93A0', lineHeight: '1.4', maxWidth: '240px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                  {streamActive && (
                    <button onClick={handleCapture} className="solid-btn" style={{ flex: 2, background: 'linear-gradient(135deg, #a3e635, #34D399)' }}>
